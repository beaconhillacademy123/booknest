...
export default async function FreeBooksPage({searchParams}:{searchParams:Promise<{q?:string;topic?:string;page?:string}>}){
  ...
  <section className="section freeBooksPage">
    ...
    <p className="sourceNote">Source: Project Gutenberg. Its catalogue focuses on works whose U.S. copyright has expired; copyright and redistribution status should still be checked for Nigeria before a book is hosted or redistributed by M King Reads.</p>
  </section></main>;
}